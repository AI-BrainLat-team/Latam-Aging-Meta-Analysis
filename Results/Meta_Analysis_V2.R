...
setwd("/home/marcelo/Documents/stored_GitRepos/Latam-Aging-Meta-Analysis/Figures/Cognition")
...
names <- c("Cog_All_funnel_en.tiff", "Cog_Demographics_funnel_en.tiff","Cog_Health_funnel_en.tiff",
           "Cog_Lifestyle_funnel_en.tiff","Cog_Mental_Health_funnel_en.tiff", "Cog_SDOH_funnel_en.tiff")
...
names <- c("Cog_All_Gosh.tiff", "Cog_Demographics_Gosh.tiff","Cog_Health_Gosh.tiff","Cog_Lifestyle_Gosh.tiff","Cog_Mental_Health_Gosh.tiff", "Cog_SDOH_Gosh.tiff")
...
for (i in 1:length(names)){
    ...
    plot(res_gosh, alpha = 0.2, het="I2", out = out[i], col=c("#3199cf","#0d5c0a"), cex.axis = 1.4,cex.lab = 1.5)
